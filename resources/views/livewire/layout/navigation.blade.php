        ...
        <nav class="flex-1 px-2 py-4 space-y-1 overflow-y-auto" style="max-height: calc(100vh - 4rem);">
            @php
                $menuItems = [
                    ...
                    ['label' => 'Backup DB', 'route' => 'backup.index', 'icon' => 'M8 7H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-3m-1 4l-3 3m0 0l-3-3m3 3V4', 'permission' => 'backup.view'],
