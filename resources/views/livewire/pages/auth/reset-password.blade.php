...
<div>
    ...
    <form wire:submit="resetPassword" class="space-y-5">
        <div>
            ...
            <x-text-input wire:model="email" id="email" class="block mt-1 w-full" type="email" name="email" placeholder="nama@email.com" required autofocus autocomplete="username" />
